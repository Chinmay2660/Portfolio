...
import { arrayCheck, projects } from "@/utils";
...
const ProjectSection = () => {
  return (
    <section className={`w-full ${SECTION_MAX_WIDTH} mx-auto py-6 md:py-8 px-4 sm:px-6 md:px-8 box-border`}>
      <motion.div
      ...
      >
        <div className="p-5 md:p-6">
          <motion.h2
            className="text-2xl font-bold text-foreground mb-5 tracking-tight"
          ...
          >
            {arrayCheck(projects) &&
              projects.map((project) => (
                <motion.div key={project.repoLink} variants={itemFadeInUp}>
                  <ProjectCard
                    title={project.title ?? ""}
